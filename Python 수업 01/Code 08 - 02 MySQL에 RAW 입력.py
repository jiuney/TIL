...
def uploadData():
    ...
    sql = "INSERT INTO rawImage_TBL(raw_id, raw_width, raw_height, raw_fname, raw_avg, raw_update, raw_uploader, raw_data)"
    sql += " VALUES(NULL, " + str(width) + ", " + str(height) + ",'" + fname + "', 0, '" + upDate + "', '" + upUser + "', %s)"
