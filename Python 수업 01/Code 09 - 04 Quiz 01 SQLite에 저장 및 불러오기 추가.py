...
def loadSqlite():
    ...
    con = sqlite3.connect(host=IP_ADDR, user=USER_NAME, password=USER_PW, db=DB_NAME, charset=CHAR_SET)
    cur = con.cursor()
...
comVisionMenu5.add_command(label="SQLite로 저장하기", command=saveSqlite)
