...
# # 히스토그램 (시각화 연습)  ----- 완전 실패 (빈도값은 당연히 256개 이상일텐데 멍청)
# def histoImage2():
#     global window, canvas, paper, filename, inImage, outImage, inH, inW, outH, outW
#     inCountList = [0] * 256
#     for i in range(inH):
#         for k in range(inW):
#             inCountList[inImage[i][k]] += 1
#     window2 = Toplevel()    # Tk()를 동시에 두번 쓸 수 없다 -- Toplevel로 바꿔줌.
#     window2.geometry("300x2000")
#     window2.title("수작업 히스토그램")
#
#     canvas2 = Canvas(window2, height=2000, width=300)  # 보드
#     paper2 = PhotoImage(height=2000, width=256)  # 빈 종이
#     canvas2.create_image((150, 1000), image=paper2, state="normal")
#
#     rgbStr2 = ""
#     for i in range(2000):
#         tmpStr2 = ""
#         for k in range(256):
#             if i == (2000 - inCountList[k]):
#                 r = g = b = 0x00
#                 tmpStr2 += " #%02x%02x%02x" % (r, g, b)
#             else:
#                 r = g = b = 0xFF
#                 tmpStr2 += " #%02x%02x%02x" % (r, g, b)
#         rgbStr2 += "{" + tmpStr2 + "} "
#     paper2.put(rgbStr2)
#
#     canvas2.pack(expand=1, anchor=CENTER)
#     window2.mainloop()
